...
public class CoreBootstrap extends BootstrapBase implements IBootstrap {
	 ...
	 * 
	 */
	public CoreBootstrap(IDataProvider db) {
		super(db);
	}
	...
	private IResult doBootstrap() {
		...
		makeSubclassNode(null,ITopicQuestsOntology.TYPE_TYPE,ICoreIcons.CLASS_ICON_SM,ICoreIcons.CLASS_ICON,"Type Type", "The TopicQuests typology root node type.", result);
			...
			makeSubclassNode(ITopicQuestsOntology.TYPE_TYPE,ITopicQuestsOntology.RELATION_TYPE,ICoreIcons.CLASS_ICON_SM,ICoreIcons.CLASS_ICON,"Relation Type", "The TopicQuests typology relation node type.", result);
				makeSubclassNode(ITopicQuestsOntology.RELATION_TYPE,ITopicQuestsOntology.MERGE_ASSERTION_TYPE,ICoreIcons.CLASS_ICON_SM,ICoreIcons.CLASS_ICON,"Merge Assertion Type", "The TopicQuests typology merge assertion node type.", result);
				makeSubclassNode(ITopicQuestsOntology.RELATION_TYPE,ITopicQuestsOntology.POSSIBLE_MERGE_ASSERTIONTYPE,ICoreIcons.CLASS_ICON_SM,ICoreIcons.CLASS_ICON,"Possible Merge Assertion Type", "The TopicQuests typology possible merge assertion node type.", result);
				makeSubclassNode(ITopicQuestsOntology.RELATION_TYPE,ITopicQuestsOntology.UNMERGE_ASSERTION_TYPE,ICoreIcons.CLASS_ICON_SM,ICoreIcons.CLASS_ICON,"Unmerge Assertion Type", "The TopicQuests typology unmerge assertion node type.", result);
		...
		//PROPERTIES
			...
			makeSubclassNode(ITopicQuestsOntology.PROPERTY_TYPE,ITopicQuestsOntology.SOLR_VERSION_PROPERTY_TYPE,ICoreIcons.PROPERTY_ICON_SM,ICoreIcons.PROPERTY_ICON,"Version Property Type", "The TopicQuests typology version property type.", result);
			...
			makeSubclassNode(ITopicQuestsOntology.PROPERTY_TYPE,ITopicQuestsOntology.IS_PRIVATE_PROPERTY,ICoreIcons.PROPERTY_ICON_SM,ICoreIcons.PROPERTY_ICON,"Is Private Property Type", "The TopicQuests typology isPrivate property type.", result);
